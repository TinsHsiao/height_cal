...
class MainWindow_controller(QMainWindow):
    ...
    def setup_control(self):
        ...
        self.img_controller = img_controller(img_path=self.file_path,
                                             ...
                                             label_first_click_pos=self.ui.label_first_click_pos,
                                             label_second_click_pos=self.ui.label_second_click_pos,
        ...
        self.ui.btn_line.clicked.connect(self.button_enter_height_line)
    ...
    def button_enter_height_line(self) :
        self.height = self.ui.box_line.text()
