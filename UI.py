...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_ratio.setGeometry(QtCore.QRect(640, 600, 641, 21))
        ...
        self.btn_line.setGeometry(QtCore.QRect(180, 700, 85, 30))
        self.btn_line.setObjectName("button_line")

        self.box_line = QtWidgets.QLineEdit(self.centralwidget)
        self.box_line.setGeometry(QtCore.QRect(60, 700, 100, 30))
        #font = QtGui.QFont()
        #font.setPointSize(10)
        #self.box_line.setFont(font)
        self.box_line.setObjectName("box line")



        self.label_first_click_pos = QtWidgets.QLabel(self.centralwidget)
        self.label_first_click_pos.setGeometry(QtCore.QRect(750, 600, 350, 20))
        self.label_first_click_pos.setObjectName("label_first_click_pos")
        self.label_second_click_pos = QtWidgets.QLabel(self.centralwidget)
        self.label_second_click_pos.setGeometry(QtCore.QRect(750, 620, 350, 20))
        self.label_second_click_pos.setObjectName("label_second_click_pos")
        self.label_real_pos = QtWidgets.QLabel(self.centralwidget)
        self.label_real_pos.setGeometry(QtCore.QRect(750, 640, 350, 20))
        self.label_real_pos.setObjectName("label_real_pos")
        self.label_norm_pos = QtWidgets.QLabel(self.centralwidget)
        self.label_norm_pos.setGeometry(QtCore.QRect(750, 660, 350, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_first_click_pos.setText(_translate("MainWindow", "first clicked position = (x, y)"))
        self.label_second_click_pos.setText(_translate("MainWindow", "second clicked position = (x, y)"))
        self.btn_line.setText(_translate("MainWindow", "Enter"))
        self.box_line.setText(_translate("MainWindow", "height"))
